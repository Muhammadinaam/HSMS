...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Default
        {
            ...
            {
                public const string BlocksIndex = "~/Modules/Default/Blocks/BlocksIndex.cshtml";
            }

            public static class Persons
            {
                public const string PersonsIndex = "~/Modules/Default/Persons/PersonsIndex.cshtml";
            }

            public static class Phases
            {
                public const string PhasesIndex = "~/Modules/Default/Phases/PhasesIndex.cshtml";
            }

            public static class Projects
            {
                public const string ProjectsIndex = "~/Modules/Default/Projects/ProjectsIndex.cshtml";
            }

            public static class Properties
            {
                public const string PropertiesIndex = "~/Modules/Default/Properties/PropertiesIndex.cshtml";
            }

            public static class PropertyTypes
            {
                public const string PropertyTypesIndex = "~/Modules/Default/PropertyTypes/PropertyTypesIndex.cshtml";
            }
        }
