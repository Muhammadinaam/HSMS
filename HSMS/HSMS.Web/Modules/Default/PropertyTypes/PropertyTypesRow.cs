...
namespace HSMS.Default.Entities
{
    ...
    [ConnectionKey("Default"), Module("Default"), TableName("[dbo].[PropertyTypes]")]
    [DisplayName("Property Types"), InstanceName("Property Types")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("PropertyTypes")]
    public sealed class PropertyTypesRow : Row, IIdRow, INameRow
    {
